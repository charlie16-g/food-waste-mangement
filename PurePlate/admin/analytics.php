...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Pure <b style="color: #06C167; ">Plate</b></p>
             <p class="user"></p>
...
<br>
<canvas id="donateChart" style="width:100%;max-width:1200px"></canvas>
...
var xplace=["Malavan","Ratnagiri","Pune","Goa","Mumbai","Kolhapur","Benglore","Hydrabad"];
